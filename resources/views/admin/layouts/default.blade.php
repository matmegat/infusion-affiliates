...
@section('styles')
    ...
    <link href="{{asset('old/assets/admin/css/plugins/metisMenu/metisMenu.min.css')}}" rel="stylesheet"}}
    {{--rel="stylesheet">--}}
    <link href="{{asset('old/assets/admin/css/sb-admin-2.css')}}" rel="stylesheet">
    {{--rel="stylesheet">--}}
    <link href="{{asset('old/assets/admin/css/jquery.dataTables.css')}}" rel="stylesheet">
    {{--rel="stylesheet">--}}
    <link href="{{asset('old/assets/admin/css/dataTables.bootstrap.css')}}" rel="stylesheet">
    {{--rel="stylesheet">--}}
    <link href="{{asset('old/assets/admin/css/colorbox.css')}}" rel="stylesheet">
